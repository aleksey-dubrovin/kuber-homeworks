...
Для расширения кластера до отказоустойчивого использую решение [kubespray](https://kubespray.io/) по инструкции используя playbook scale.yml с версией v2.25.0. Генерация инвентори файла по шаблону выполняется через terraform.
